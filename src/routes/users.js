...
import { createUserValidationSchema, queryParamsValidationSchema } from '../utils/validationSchemas.js';
...
router.get('/api/users', checkSchema(queryParamsValidationSchema), async (request, response) => {
...
router.get('/api/users/:id', resolveIndexByUserId, (request, response) => {
  ...
  const findUser = mockedUsers.find(user => user.id === mockedUsers[findUserIndex].id);
